...
pubDate: 2026-02-22
description: "The abxylute N6 solves the Joy-Con's biggest problems — comfort and controls — but one glaring design choice might be a dealbreaker before you even pick it up."
author: "Chris Cowley"
tags: ["accessories", "nintendo", "reviews", "consoles", "sponsored"]
youtube: "dyEFYEKHo5g"
image: "/images/abxylute-n6-review.jpg"
---
...
Here's the issue that will make or break the N6 for most people: the corners of the [Switch 2](/blog/its-finally-time-to-get-a-switch-2) stick out completely. There's no protection around the edges of the screen, and no case is going to fix that while the N6 is attached. It's reminiscent of an upside-down [PlayStation Portal](/blog/ps-portal-review) — a device that has survived over two years of use without damage — but the Switch 2 simply isn't designed to have those areas exposed in the same way.
