...
author: "Chris Cowley"
tags: ["reviews", "lifestyle", "sponsored"]
youtube: "YbA52Efn7G0"
...
The 60Hz refresh rate might look like a limitation on a spec sheet, but in practice it's not much of a compromise for the kind of gaming this projector is built around. The latency is impressively low, which makes it a genuinely good match for handheld consoles like a [Steam Deck](/blog/steam-deck) or a [Legion Go S](/blog/legion-go-s) — and realistically, those devices are unlikely to push much beyond 60 frames per second for most games anyway. Gaming on a projected image that fills your wall is a different experience entirely from gaming on a handheld screen, and the MoGo 4 makes that jump feel natural.
