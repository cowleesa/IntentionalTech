...
author: "Chris Cowley"
image: "/images/elo-vagabond.jpg"
tags: ["ipad", "accessories", "reviews", "sponsored"]
---
...
The Vagabond feels genuinely transformative paired with the iPad Mini. It's the first time I've used a mobile controller and felt it could realistically compete with something like the [PlayStation Portal](/blog/ps-portal-review), at least on the hardware side. The software limitations of iOS and Android inevitably get in the way at some point, and it can't match a [Steam Deck](/blog/steam-deck) or Legion Go for sheer versatility — but as a gaming setup it feels cohesive and intentional in a way that few mobile controllers manage.
