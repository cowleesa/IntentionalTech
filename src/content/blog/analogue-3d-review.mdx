...
Analogue seem to have this spirit in mind when designing their operating systems. As with the [Analogue Pocket](/blog/analogue-pocket), the 3DOS is deliberately minimal — it gets out of the way and puts you into the game as quickly as possible. At times it can be a touch confusing, but the overall intention is clear and welcome.
